  ...
  return (
    <div>
      ...
      <p className="fw-lighter">
        This privacy notice for Megaplux Global Limited ("Company," "we," "us,"
      ...
      <h5 className="fw-bolder">SUMMARY OF KEY POINTS</h5>
      <p className="fst-italic fw-bold">
        ...
        <a href="#" className="card-link fst-italic fw-bold">
          here
        </a>{" "}
      ...
      <p className="fw-lighter">
        ...
        how you interact with Megaplux Global Limited and the Services, the
      ...
      <p className="fw-lighter">
        How do I exercise my rights? The easiest way to exercise your rights is
        by filling out our data subject request form available{" "}
        <a href="#" className="card-link">
          here
        </a>
        : __________, or by contacting us. We will consider and act upon any
        request in accordance with applicable data protection laws.
      </p>
      <p className="fw-lighter">
        Want to learn more about what Megaplux Global Limited does with any
        information we collect? Click here to review the notice in full.
      </p>
      <h5 className="fw-bolder">TABLE OF CONTENTS</h5>
      <a href="#" className="card-link">
      ...
      <h5 className="fw-bolder">1. WHAT INFORMATION DO WE COLLECT?</h5>
      <h6 className="fw-bolder">Personal information you disclose to us</h6>
      ...
      <p className="fw-lighter">
        ...
        instrument. All payment data is stored by Paystack. You may find their
      ...
      <h6 className="fw-bolder">Information automatically collected</h6>
      <p className="fst-italic">
      ...
      <p className="fw-lighter">The information we collect includes:</p>
      <ul>
        <li>
      ...
      <h5 className="fw-bolder">2. HOW DO WE PROCESS YOUR INFORMATION?</h5>
      <p className="fst-italic">
        {" "}
      ...
      <p className="fst-italic">
        ...
        <p className="fw-lighter">
          ...
          follows: We also may need to share your personal information in the
        ...
        <h5 className="fw-bolder">4. HOW LONG DO WE KEEP YOUR INFORMATION?</h5>
        <p className="fst-italic">
        ...
        <h5 className="fw-bolder">5. HOW DO WE KEEP YOUR INFORMATION SAFE?</h5>
        <p className="fst-italic">
        ...
        <h5 className="fw-bolder">6. WHAT ARE YOUR PRIVACY RIGHTS?</h5>
        <p className="fst-italic">
      ...
      <h6 className="fw-bolder">Account Information</h6>
      <p className="fw-lighter">
      ...
      <h5 className="fw-bolder">7. CONTROLS FOR DO-NOT-TRACK FEATURES</h5>
      <p className="fw-lighter">
      ...
      <h5 className="fw-bolder">9. DO WE MAKE UPDATES TO THIS NOTICE?</h5>
      <p className="fst-italic">
      ...
      <p className="fw-lighter">
        ...
        info@cucumislush.com or by post to:
      </p>
      <p className="fw-lighter">
        Megaplux Global Limited
        <br />
        Albert Macaulay street, Yaba , Lagos.
        <br />
        Yaba, Lagos State
        <br />
        Nigeria
